...
export default function Checkout({
	...
	return (
		<div className="w-full px-4 py-2 flex flex-col bg-white rounded-lg shadow">
			...
			<div className="flex justify-between items-center my-2 border-t border-gray-200 pt-4 pb-2">
			...
			<div className="flex mt-4 sm:mt-6 gap-2 text-3xs border-t border-gray-100 pt-2 text-gray-400 justify-between items-center text-center">
